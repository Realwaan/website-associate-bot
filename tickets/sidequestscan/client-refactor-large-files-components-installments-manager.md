# Refactor Large Files in components/installments-manager
...
- `components/installments-manager/installments-manager-screen.tsx`

## What to Fix

1. `components/installments-manager/installments-manager-screen.tsx`: File has 1165 lines (threshold: 300). Consider refactoring.
