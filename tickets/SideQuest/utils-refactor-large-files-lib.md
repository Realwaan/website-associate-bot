...
1. `lib/notifications.ts`: File has 327 lines (threshold: 300). Consider refactoring.
2. `lib/wallet-badges.ts`: File has 625 lines (threshold: 300). Consider refactoring.
